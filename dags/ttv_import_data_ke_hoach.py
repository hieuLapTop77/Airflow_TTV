...
def Ke_hoach_TTV():
    ...
    @task
    def insert_kehoach_vanhanh_BH_MT_DT():
        file_local = get_url()
        sql = """
            INSERT INTO [dbo].[KeHoach_VanHanh_BH_MT_DT] (
                    [MA_HANG_HOA]
                    ,[TEN_HANG_HOA]
                    ,[KA_20240101]
                    ,[SIEU_THI_20240101]
        ...
        """
        insert_data(path_file=file_local, query=sql, table_name="[dbo].[KeHoach_VanHanh_BH_MT_DT]",
                    sheet_name="Kế hoạch vận hành BH MT (DT)", skip_rows=1)
    ...
    @task
    def insert_kehoach_vanhanh_BH_TT_DT():
        file_local = get_url()
        sql = """
            INSERT INTO [dbo].[KeHoach_VanHanh_BH_TT_DT]
                    ([MA_HANG_HOA]
                    ,[TEN_HANG_HOA]
                    ,[DCYK_20240101]
                    ,[PHARMA_20240101]
        ...
        """
        insert_data(path_file=file_local, query=sql, table_name="[dbo].[KeHoach_VanHanh_BH_TT_DT]",
                    sheet_name="Kế hoạch vận hành BH TT (DT)", skip_rows=1)
    ...
    @task
    def insert_kehoach_vanhanh_BH_Online_DT():
        file_local = get_url()
        sql = """
            INSERT INTO [dbo].[KeHoach_VanHanh_BH_Online_DT] (
                   [MA_HANG_HOA]
                ,[TEN_HANG_HOA]
                ,[ECOM_20240101]
                ,[ABCARE_20240101]
        ...
        """
        insert_data(path_file=file_local, query=sql, table_name="[dbo].[KeHoach_VanHanh_BH_Online_DT]",
                    sheet_name="Kế hoạch vận hành BH Online DT", skip_rows=1)
    ...
    @task
    def insert_kehoach_vanhanh_BH_LocNuoc_DT():
        file_local = get_url()
        sql = """
                INSERT INTO [dbo].[KeHoach_VanHanh_BH_LocNuoc_DT]
                        ([MA_HANG_HOA]
                        ,[TEN_HANG_HOA]
                        ,[LN_20240101]
                        ,[LN_BCA_20240101]
        ...
        """
        insert_data(path_file=file_local, query=sql, table_name="[dbo].[KeHoach_VanHanh_BH_LocNuoc_DT]",
                    sheet_name="Kế hoạch BH Lọc nước DT", skip_rows=1)
    ...
    @task
    def insert_kehoach_vanhanh_BH_BCA_DT():
        file_local = get_url()
        sql = """
                INSERT INTO [dbo].[KeHoach_VanHanh_BH_BCA_DT]
                        ([MA_HANG_HOA]
                        ,[TEN_HANG_HOA]
                        ,[BCA_20240101]
                        ,[KENH_BCA_1_20240101]
        ...
        """
        insert_data(path_file=file_local, query=sql, table_name="[dbo].[KeHoach_VanHanh_BH_BCA_DT]",
                    sheet_name="Kế hoạch vận hành BH BCA DT", skip_rows=1)
    ...
    download_latest_file() >> insert_kehoach_nam() >> insert_kehoach_vanhanh_BH_MT() >> insert_kehoach_vanhanh_BH_MT_DT() >> insert_kehoach_vanhanh_BH_TT() >> insert_kehoach_vanhanh_BH_TT_DT() >> insert_kehoach_vanhanh_BH_Online() >> insert_kehoach_vanhanh_BH_Online_DT() >> insert_kehoach_vanhanh_BH_LocNuoc(
    ) >> insert_kehoach_vanhanh_BH_LocNuoc_DT() >> insert_kehoach_vanhanh_BH_BCA() >> insert_kehoach_vanhanh_BH_BCA_DT() >> insert_kehoach_BH_Thang() >> insert_kehoach_Kenh_DonVi() >> insert_sanpham_NhomSP_Brand() >> move_files()
