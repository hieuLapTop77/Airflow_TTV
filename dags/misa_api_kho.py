    ...
    def insert_kho(data: list) -> None:
        ...
        sql = """
            INSERT INTO [dbo].[3rd_misa_api_kho](
                [dictionary_type],[is_sync_corp],[stock_id],[branch_id],[inactive],[stock_code],[stock_name],[inventory_account],
                [reftype_category],[reftype],[from_stock_id],[to_stock_id],[isCustomPrimaryKey],[isFromProcessBalance],[excel_row_index],
                [is_valid],[created_date],[created_by],[modified_date],[modified_by],[auto_refno],[pass_edit_version],[state],[description],[dtm_creation_date])
